...
export function AddUserDialog({ isOpen, onOpenChange, onUserAdded }: AddUserDialogProps) {
  ...
  async function onSubmit(values: AddUserFormValues) {
    ...
    if (!functions) {
      console.error("Firebase Functions instance is undefined in AddUserDialog. Check Firebase initialization in lib/firebase.ts and environment configuration.");
      toast({
        title: "Configuration Error",
        description: "Firebase Functions service is not available. Please contact support.",
        variant: "destructive",
      });
